...
-- Codigo operacion: D_MOVIMIENTO_OPERACIONES
-- Descripcion operacion: D_OPERACION => DESC_OPERACION

SELECT * FROM D_OPERACIONES;

SELECT SUM(DO.IMPORTE_IVA), O.DESC_OPERACION FROM D_DETALLE_OPERACIONES DO
INNER JOIN D_MOVIMIENTO_OPERACIONES MO ON MO.COD_OPERACION = DO.ID_OPERACION
INNER JOIN D_OPERACIONES O ON O.COD_OPERACION = MO.COD_OPERACION
